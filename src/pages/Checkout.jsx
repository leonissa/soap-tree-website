      ...
      <div className="bg-eternita-white border-b border-eternita-taupe/40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <Link to="/" className="flex items-center gap-2 w-fit">
            ...
            <span className="font-serif text-xl font-bold text-eternita-teal">Soap Tree</span>
          </Link>
        </div>
      </div>
          ...
          <div className="lg:col-span-3">
            ...
            {step === 3 && confirmed && (
              <div className="bg-eternita-white rounded-2xl p-8 md:p-10 border border-eternita-taupe/30 text-center">
                ...
                <p className="text-eternita-gray text-sm mb-4">Thank you for choosing Soap Tree. Your wellness journey begins now.</p>
