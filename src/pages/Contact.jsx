...
const contactMethods = [
  {
    ...
    details: ['9301 Tampa Ave', 'Northridge, CA 91324'],
  },
  {
    label: 'Call Us',
    icon: (
  ...
  },
  {
    ...
    details: ['thesoaptreenorthridge@gmail.com'],
  },
  {
    ...
    details: ['Open Daily: 11:00 AM – 8:00 PM'],
  },
];
      ...
      <section className="bg-gradient-to-br from-eternita-teal-dark via-eternita-teal to-eternita-teal-light py-20 md:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-left">
          ...
          <p className="text-eternita-white/70 max-w-2xl text-sm md:text-lg">
            Ready to experience The Soap Tree? Reach out to our team and take the first step toward a more radiant you.
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-5 gap-12">
            ...
            <div className="md:col-span-2">
              <div className="bg-gradient-to-br from-eternita-teal to-eternita-teal-dark rounded-3xl p-8 text-eternita-white sticky top-28">
                <h3 className="font-serif text-xl font-bold mb-4">Why Choose The Soap Tree in Northridge?</h3>
                <ul className="space-y-4">
                  {[
                    ...
                    'A serene, spa-like environment in the heart of Northridge',
                  ].map((item, i) => (
                ...
                <div className="mt-8 pt-6 border-t border-white/20">
                  ...
                  <a href="tel:+18186343007" className="text-xl font-bold hover:text-eternita-coral-light transition-colors">
                    (818) 634-3007
                  </a>
                </div>
              </div>
      ...
      <section className="py-20 md:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="tel:+18186343007" className="btn-primary">
              Call to Book
            </a>
