...
const values = [
  {
    ...
    desc: 'Every treatment at The Soap Tree is supervised by licensed medical professionals. We invest in the latest FDA-cleared technology and adhere to the highest clinical standards in the industry.',
    icon: (
...
const faqs = [
  ...
  },
  {
    ...
    a: 'Unlike traditional day spas, a medical spa operates under the supervision of licensed medical professionals and offers clinical-grade treatments that go beyond the surface. At The Soap Tree, every treatment is performed or overseen by registered nurses and nurse practitioners using advanced medical technology.',
  },
  {
      ...
      <section className="bg-gradient-to-br from-eternita-teal-dark via-eternita-teal to-eternita-teal-light py-20 md:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-left">
          ...
          <p className="text-eternita-white/70 max-w-2xl text-sm md:text-lg">
            The Soap Tree was founded with one belief — that everyone deserves access to medical-grade skincare in an environment that feels like a sanctuary.
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="font-serif text-3xl md:text-4xl font-bold text-eternita-dark mt-3 mb-6">
                Rooted in Southern California, Built for You
              </h2>
              <div className="space-y-4 text-eternita-gray text-sm md:text-base leading-relaxed">
                <p>
                  The Soap Tree was born from a simple observation: the med spa industry was full of hype but short on genuine, results-driven care. Our founders — a team of registered nurses and wellness practitioners — wanted to create something different: a place where advanced medical aesthetics meets authentic hospitality.
                </p>
                <p>
                  We opened our doors in Northridge with a clear mission: to offer transformative treatments in a space that feels more like a wellness retreat than a clinic. Nestled near the Northridge Fashion Center and serving the greater San Fernando Valley and Los Angeles area, every detail from the warm finishes to the curated treatment menu was designed with intentionality.
                </p>
                <p>
                  Today, The Soap Tree is home to a team of over 20 licensed professionals, each committed to continuing education and mastering the latest techniques. We invest in the best technology, the finest products, and — most importantly — genuine relationships with every client who walks through our doors in Southern California.
                </p>
                <p>
                  Whether you are a first-time visitor or a longtime member, you are not just a client at The Soap Tree. You are part of our family.
                </p>
              </div>
            </div>
            <div className="h-80 md:h-96 rounded-3xl overflow-hidden">
              <img
                ...
                alt="The Soap Tree story - Northridge, CA"
      ...
      <section className="py-16 md:py-24 bg-eternita-light">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="font-serif text-xl md:text-2xl italic text-eternita-dark/80 leading-relaxed mb-6">
            "We believe that beauty is about revealing the most radiant version of yourself — just like the golden glow of Southern California. At The Soap Tree in Northridge, we combine science, art, and genuine care to help you glow from the inside out, every day of the year."
          </p>
      ...
      <section className="py-20 md:py-28">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <p className="text-eternita-gray mt-4 max-w-xl mx-auto text-sm md:text-base">
              Everything you need to know before your first visit to The Soap Tree.
            </p>
          </div>
